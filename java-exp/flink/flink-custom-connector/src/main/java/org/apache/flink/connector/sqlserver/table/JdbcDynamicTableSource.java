...
import org.apache.flink.connector.sqlserver.split.CompositeJdbcParameterValuesProvider;
import org.apache.flink.connector.sqlserver.split.JdbcGenericParameterValuesProvider;
import org.apache.flink.connector.sqlserver.split.JdbcNumericBetweenParametersProvider;
...
public class JdbcDynamicTableSource
    ...
    public ScanRuntimeProvider getScanRuntimeProvider(ScanContext runtimeProviderContext) {
        ...
        if (limit >= 0) {
            ...
            query =
                    dialect.getSelectTopFromStatement(
