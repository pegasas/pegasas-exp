...
package org.apache.flink.connector.sqlserver.table;

import org.apache.flink.annotation.Internal;
import org.apache.flink.configuration.ConfigOption;
import org.apache.flink.configuration.ConfigOptions;
import org.apache.flink.configuration.ReadableConfig;
import org.apache.flink.connector.sqlserver.JdbcExecutionOptions;
import org.apache.flink.connector.sqlserver.dialect.JdbcDialect;
import org.apache.flink.connector.sqlserver.dialect.JdbcDialectLoader;
import org.apache.flink.connector.sqlserver.internal.options.InternalJdbcConnectionOptions;
import org.apache.flink.connector.sqlserver.internal.options.JdbcDmlOptions;
import org.apache.flink.connector.sqlserver.internal.options.JdbcReadOptions;
...
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.COMPATIBLE_MODE;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.DRIVER;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.LOOKUP_CACHE_MAX_ROWS;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.LOOKUP_CACHE_MISSING_KEY;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.LOOKUP_CACHE_TTL;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.LOOKUP_MAX_RETRIES;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.MAX_RETRY_TIMEOUT;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.PASSWORD;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.SCAN_AUTO_COMMIT;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.SCAN_FETCH_SIZE;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.SCAN_PARTITION_COLUMN;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.SCAN_PARTITION_LOWER_BOUND;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.SCAN_PARTITION_NUM;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.SCAN_PARTITION_UPPER_BOUND;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.SINK_BUFFER_FLUSH_INTERVAL;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.SINK_BUFFER_FLUSH_MAX_ROWS;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.SINK_MAX_RETRIES;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.SINK_PARALLELISM;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.TABLE_NAME;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.URL;
import static org.apache.flink.connector.sqlserver.table.JdbcConnectorOptions.USERNAME;
